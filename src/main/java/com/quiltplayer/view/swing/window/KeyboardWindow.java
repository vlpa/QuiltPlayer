...
public class KeyboardWindow extends JFrame
{
	...
	String[] row1 = new String[] { "1", "2", "3", "4", "5", "6", "7", "8", "9",
			"0" };
	String[] row2 = new String[] { "Q", "W", "E", "R", "T", "Y", "U", "I", "O",
			"P", };
	String[] row3 = new String[] { "A", "S", "D", "F", "G", "H", "J", "K", "L" };
	String[] row4 = new String[] { "Z", "X", "C", "V", "B", "N", "M" };
	String[] row5 = new String[] { " " };

	public KeyboardWindow(final JTextField textField)
	{
		...
		setLocation(Toolkit.getDefaultToolkit().getScreenSize().width / 2
				- ((int) this.getWidth() / 2), Toolkit.getDefaultToolkit()
