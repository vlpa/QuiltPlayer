 ...
 * 
 */
public class QMetalTheme extends DefaultMetalTheme
{
	private static final Color BACKGROUND = Configuration
			.getInstance().getColorConstants().getBackground();
	 ...
	 * 
	 * @see
	 * javax.swing.plaf.metal.MetalTheme#addCustomEntriesToTable(javax.swing
	 * .UIDefaults)
	 */
	@Override
	...
	private void setupTextField()
	{
		...
		UIManager.put("TextField.foreground", Configuration
				.getInstance().getColorConstants().getArtistViewTextColor());
		UIManager.put("PasswordField.foreground", Configuration
				.getInstance().getColorConstants().getArtistViewTextColor());

		UIManager.put("TextField.inactiveForeground", new Color(70, 70, 70));
		UIManager
				.put("PasswordField.inactiveForeground", new Color(70, 70, 70));
		...
		UIManager
				.put("PasswordField.caretForeground", new Color(160, 160, 160));
		...
		UIManager.put("TextField.border",
				new CompoundBorder(bdButton, bdMargin));
		UIManager.put("PasswordField.border", new CompoundBorder(bdButton,
				bdMargin));
	}
