...
public final class Configuration implements Serializable
{
	...
	private int albumColumns = 3;

	private int artistColumns = 3;

	private int quiltColumns = 3;
	...
	/**
	 * @return the albumColumns
	 */
	public int getAlbumColumns()
	{
		return albumColumns;
	}
	...
	/**
	 * @param albumColumns
	 *            the albumColumns to set
	 */
	public void setAlbumColumns(int albumColumns)
	{
		if (albumColumns >= 1)
			this.albumColumns = albumColumns;
	}

	/**
	 * @return the artistColumns
	 */
	public int getArtistColumns()
	{
	...
	/**
	 * @param artistColumns
	 *            the artistColumns to set
	 */
	public void setArtistColumns(int artistColumns)
	{
		if (artistColumns >= 1)
			this.artistColumns = artistColumns;
	}

	/**
	 * @return the quiltColumns
	 */
	public int getQuiltColumns()
	{
		return quiltColumns;
	}
	...
	/**
	 * @param quiltColumns
	 *            the quiltColumns to set
	 */
	public void setQuiltColumns(int quiltColumns)
	{
		if (quiltColumns >= 1)
			this.quiltColumns = quiltColumns;
	}
	...
	/*
	 * @see
	 * org.quiltplayer.core.storage.Storage#storeConfiguration(org.quiltplayer
	...
	public static Configuration retrieveConfiguration()
	{
		...
		try
		{
			...
			Configuration config = (Configuration) in
					.readObject();
			in.close();
