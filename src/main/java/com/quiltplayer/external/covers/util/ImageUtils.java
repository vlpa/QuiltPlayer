...
public class ImageUtils
{
	...
	{
		return ((Double) java.awt.Toolkit.getDefaultToolkit().getScreenSize()
				.getWidth()).intValue();
	}
	...
	{
		ImageIcon imageIcon = new ImageIcon(icon.getImage().getScaledInstance(
		...
		BufferedImage bi = new BufferedImage(imageIcon.getIconWidth()
				+ (2 * borderWidth + 2 * spaceAroundIcon), imageIcon
				.getIconHeight()
		...
		g.drawImage(imageIcon.getImage(), borderWidth + spaceAroundIcon,
	...
	{
		ImageIcon imageIcon = new ImageIcon(image.getScaledInstance(width, -1,
				Image.SCALE_SMOOTH));
		int borderWidth = 1;
		int spaceAroundIcon = 0;
		Color borderColor = new Color(40, 40, 40);
