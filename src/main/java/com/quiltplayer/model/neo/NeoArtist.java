...
public class NeoArtist extends NeoTx implements Artist, Comparable<Artist>
{
	...
	{
		return new ArtistName((String) NeoSingelton.getInstance().getNeoUtil()
				.getProperty(node, PROPERTY_NAME));
	}

	/*
	 * @see
	 * com.quiltplayer.model.ArtistInterface#addAlbum(com.quiltplayer.model.
	 * Album)
	 */
	@Override
	...
	/*
	 * @see
	 * com.quiltplayer.model.ArtistInterface#removeAlbum(com.quiltplayer.model.
	 * Album)
	 */
	@Override
	public void removeAlbum(final Album album)
	{
		...
		{
			if (rel.getEndNode().getId() == ((NeoAlbum) album).getNode()
					.getId())
				rel.delete();
		}
	...
	/*
	 * @see
	 * com.quiltplayer.model.Artist#setArtistName(com.quiltplayer.model.ArtistName
	 * )
	 */
	@Override
	public void setArtistName(final ArtistName artistName)
	{
		NeoSingelton.getInstance().getNeoUtil().setProperty(node,
				PROPERTY_NAME, artistName.getName());
	}
	...
	public int compareTo(final Artist o)
	{
		...
		return ((String) node.getProperty(PROPERTY_NAME)).compareTo(o
	...
	public boolean hasAlbums()
	{
		...
		Traverser nodes = node.traverse(Traverser.Order.DEPTH_FIRST,
	...
	public boolean hasAlbum(Album album)
	{
		...
		else
		{
			for (Node node : c)
			{
				if (node.getProperty(NeoAlbum.PROPERTY_ID).equals(
						album.getId().getId()))
				{
					finishTx(tx);
					return true;
